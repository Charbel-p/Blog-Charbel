                ...
                <div class="shrink-0 flex items-center">
                        <a href="{{ route('posts.index') }}">
                            <div class="flex items-center gap-2">
                                <div class="w-8 h-8 rounded-lg bg-brand-600 flex items-center justify-center text-white font-bold text-xs">C</div>
                                <span class="hidden lg:inline font-semibold text-brand-900 text-sm">Le blog de Charbel</span>
                            </div>
                        </a>
                </div>
